...
public:
	...
	vector_wrapper_linear(const vector_wrapper_linear& x) :impl(x.impl) {}
	vector_wrapper_linear& operator=(const vector_wrapper_linear& x) { impl = x.impl; return *this; }
...
public:
	...
	vector_wrapper_binary(const vector_wrapper_binary& x) :impl(x.impl) {}
	vector_wrapper_binary& operator=(const vector_wrapper_binary& x) { impl = x.impl; return *this; }
